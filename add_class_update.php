		...
		<!-- <img src="img/bg1.jpg" style="margin-left:90px;" class="sha"> -->
			<div id="section">
				...
				<select name="cname"  required class="input2">
					...
					<option value="Grade 6" <?php echo addSelected($clname, "Grade 6") ?>>Grade 6</option>
					<option value="Grade 7" <?php echo addSelected($clname, "Grade 7") ?>>Grade 7</option>
					<option value="Grade 8" <?php echo addSelected($clname, "Grade 8") ?>>Grade 8</option>
					<option value="Grade 9" <?php echo addSelected($clname, "Grade 9") ?>>Grade 9</option>
					<option value="Grade 10" <?php echo addSelected($clname, "Grade 10") ?>>Grade 10</option>
					<option value="Grade 11" <?php echo addSelected($clname, "Grade 11") ?>>Grade 11</option>
					<option value="Grade 12" <?php echo addSelected($clname, "Grade 12") ?>>Grade 12</option>
					<option value="Grade 13" <?php echo addSelected($clname, "Grade 13") ?>>Grade 13</option>
				</select><br><br>
