			...
			<div id="section">
					...
					<div class="lbox">
						...
						<label style="color: black;"> Select Term</label><br>
							<select name="etype" required class="input3">
						       ...
						       <option value="1st Term" <?php echo addSelected($term, "1st Term") ?>>1st Term</option>
						       <option value="2nd Term" <?php echo addSelected($term, "2nd Term") ?>>2nd Term</option>
						       <option value="3rd Term" <?php echo addSelected($term, "3rd Term") ?>>3rd Term</option>
							</select>
					<br><br>
				...
				<div class="rbox">
					...
					<select name="cla" required class="input3">
                        <option value="Grade 6" <?php echo addSelected($exam_class, "Grade 6");?>>Grade 6</option>
                        <option value="Grade 7" <?php echo addSelected($exam_class, "Grade 7");?>>Grade 7</option>
